...
var getArtists = function() {
  ...
  return new Promise(function(resolve, reject) {
    const sql = "SELECT artist_name, artist_birthday, artist_location, label_id, artist_id FROM artist \
...
var addArtist = function(artist_id, artist_name, artist_birthday, artist_location, label_id) {
